...
def test_like_result_is_c_contiguous_from_f_input() raises:
    ...
    var src = la.matrix[DType.float64]([[1.0, 2.0], [3.0, 4.0]], "F")
...
def test_arange_zero_step_raises() raises:
    ...
    var raised = False
    try:
        var _m = arange[DType.float64](0.0, 5.0, 0.0)
    except:
        raised = True
...
def test_arange_empty_range_raises() raises:
    ...
    var raised = False
    try:
        var _m = arange[DType.float64](5.0, 0.0, 1.0)
    except:
        raised = True
...
def test_linspace_descending() raises:
    ...
    var mat = linspace[DType.float64](1.0, 0.0, 3)
    testing.assert_equal(mat[0, 0], 1.0)
...
def test_linspace_zero_num_raises() raises:
    ...
    var raised = False
    try:
        var _m = linspace[DType.float64](0.0, 1.0, 0)
    except:
        raised = True
